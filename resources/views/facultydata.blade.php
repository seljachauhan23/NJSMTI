...
<html lang="en">
  <head>
    <title>Faculty(Req.pending) Data</title>
    <style>
      .div {
     display: flex;
    align-items: center;
...
@endif
    ...
    <div>
     ...
     <div class="h1">Faculty(Req.pending) Data</div><br><br>
        <!-- <a href="{{url('/addfaculty')}}"><button>ADD</button></a> -->
    <table class="table">
            <thead>
                <tr>
                    <th>Full Name</th>
            ...
            <tbody>
                ...
                <tr>
                   ...
                   <td> {{$faculty->password}}</td>
                    ...
                    <td><a href="{{url('')}}/approv/{{$faculty->email}}"><button class="btn4">Approve</button><a></td>
                    <td><a href="{{url('')}}/fdelete1/{{$faculty->email}}"><button class="btn3">Reject</button></a></td>
                    @endforeach
                </tr>
