...
<html lang="en">
  ...
  <body style=" ">
    ...
    <div>
     ...
     <div class="h1">Login Desk</div><br><br>
     @if(isset($fail))
     <h4>{{$fail}}</h4>
     @endif
     ...
     @endif
        ...
        <center>
                    <img style=" " class="im" src="https://w7.pngwing.com/pngs/544/1/png-transparent-computer-icons-login-icon-design-others-logo-silhouette-share-icon.png" alt="">
                </center>
           
            <center><h3 style=" " class="h3">Make Your Logged In</h3></center>
            
                <div style=" " class="dv1">
                    <form action="" method="post">
                      @csrf
                     <input type="email" placeholder="Enter Your Email" name="email" style="  " class="input" required><br><br>
                    <input type="password" placeholder="Enter Your Password " name="pwd" style=" " class="input" required><br><br>
                    <select name="role" value="Enter Your Login Role"  style=" " class="input" required>
                        <option value="Director">Director</option>
                        <option value="Faculty">Faculty</option>
                        <option value="Student">Student</option>
                    </select><br><br>
                   <a href="{{url('/forgot_pwd')}}" style=" " class="a">Forgot Password ?</a><br><br>
                   
                    <input type="submit" name="btn" value="LOGIN" style=" " class="btn1"><br><br><br>
                    </form>  
                </div>
