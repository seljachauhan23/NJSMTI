...
<html lang="en">
  ...
  <body>
    ...
    <div>
     ...
     <div class="h1">Varify Desk</div><br><br>
     @if(isset($err))
     <h4>{{$err}}</h4>
     @endif
        <div class="dv">
        ...
        <center>
                    <img style=" " class="im"src="https://img.freepik.com/premium-vector/protected-3d-email-green-envelope-with-attached-file-with-safeguard-shield-check-symbol_87850-488.jpg" alt="">
                </center>
           
            <center><h3 style=" " class="h3">Varify That's You.. </h3></center>
            
                <div style=" " class="dv1">
                    <form action ="{{url('')}}/varify"method="post">
                      @csrf
                     <input type="email" placeholder="" name="email" style=" " class="input" value=" {{$email}}" readonly><br><br>
                     <input type="number" placeholder="Enter Your OTP" name="otp" style= " " class="input"required><br><br>
                    
                    
                   
                    <input type="submit" name="btn" value="Varify" style=" " class="btn1"><br><br><br>
                    </form>  
                </div>
