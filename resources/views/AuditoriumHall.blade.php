...
.div2 {
  ...
  <div>
        <div class="dv">
            <center> <h1 style="" class="hh1">Auditorium Hall</h1></center>
        </div>
        <br>
        <div style=" " class="div1">
            <h3 style=" " class="hh3"><b>Auditorium Hall</b></h1>
            <p style=" ">For the sack of different academic and training programs 
        the institute having 2 auditoriums with the capacity of 150 persons each.</p>
        </div>
        <div style=" background:linear-gradient(to bottom,#000080,#63C5DA);;display: inline-box; margin-left:20px; margin-right:20px;border-radius:20px;">
            <div style="display: inline-box;margin-left:15%;padding:23px;">
                <img class="im" src="https://www.veravaleducationsociety.org/njsmti/img/about/audi1.jpeg" alt="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img  class="im"  src="https://www.veravaleducationsociety.org/njsmti/img/about/audi2.jpeg" alt=""><br><br>
                <img class="im" src="https://www.veravaleducationsociety.org/njsmti/img/about/audi3.jpg" alt="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img  class="im"  src="https://www.veravaleducationsociety.org/njsmti/img/about/audi4.jpg" alt="">
            </div>
        </div>
    </div><br>
