...
<html lang="en">
  <head>
    <title>ANTI RAGGING AND ANTI RAGGING SQUAD COMMITTEE</title>
    <style>
        .dv{
  ...
  <div>
            <div class="dv">
                <center> <h1 style=" " >ANTI RAGGING AND ANTI RAGGING SQUAD COMMITTEE</h1></center>
            </div><br>
            <div style="" class="dv1">
                <img style="" class=" im1" src="https://www.veravaleducationsociety.org/njsmti/img/antir.jpg" alt="">
