...
@endif
  <div><div class="div">
    ...
    <div>
     ...
     <div class="h1">Upload Material</div><br><br>
     @if(isset($m))
     <h4>{{$m}}</h4>
     @endif
        <div class="dv">
        <center>
                    <img style="" class="im"src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPRLrJnk-HUcbOyK_ftrRQdPGIznuBjdTORw&usqp=CAU" alt="">
                </center>
           
            <center><h3 style="" class="h3">Upload Material</h3></center>
            
                <div  class="dv1" style="margin-left:250px;">
                    <form method="post">
                        @csrf
            ...
            <select name="semester" class="input" style ="height:50px" required>
        ...
        <option value="MBA SEM 4">MBA SEM 4</option>
                            ...
                            <br><br>
                            <input type="text" name="topic" placeholder="Enter Topic Name" class="input" style ="height:50px" required></span><br><br>
                            <input type="text" name="material_path" placeholder="Study Material Public Link(Google Drive,One Drive Etc.)"  class="input" style ="height:50px" required>
            <br><br>
            <input type="submit" name="submit" value="Upload" class="btn1" style="margin-left:65px;">
        </form>
    </div>
...
function Speech() {
    if ('speechSynthesis' in window) {
        ...
        window.speechSynthesis.onvoiceschanged = function() {
            ...
            message.text = "Upload study material";
