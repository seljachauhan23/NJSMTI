...
@endif
  ...
  <div class="div">
    ...
    <div>
     ...
     <div class="h1">Resolved Quries</div><br><br>
        <table class="table">
            <thead>
                <tr>
                    <th>Student E-Main ID</th>
                    <th>Resolved Query</th>
                    <th>Click if query from Resolved Query</th>
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$reply->email}}</td>
                    <td>{{$reply->query}}</td>
                    <td><a href="{{url('/squery')}}"><button class="btn5">Click</button></a></td>
