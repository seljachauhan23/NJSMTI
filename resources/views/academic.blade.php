...
<html lang="en">
  ...
  <body>
    ...
    <div style="display:inline-block;">
            <div class=" dv " style=" ">
                <h3 style="" class="hh3">Academic</h3>
                <h4>GUJARAT TECHNOLOGICAL UNIVERSITY Master of Business Administration(MBA)</h4>
                
                <p style="color:#000080;font-family: serif;font-size: 16px;text-align: justify;
                text-justify: inter-word;">
                MBA SYLLABUS(GTU Website)
                </p>
            </div>
            <div style=""class="image">
                <img style="" class="img1"src="https://www.veravaleducationsociety.org/njsmti/img/about/acadamy.png" alt="">
        </div>
    </div>
    <!-- Optional JavaScript -->
