    ...
    align-items: center;
       ...
       h3{
        ...
        .btn1{
          ...
          width: 260px;
           height: 60px;
           background:#000080;color:yellow;
           font-weight:bold;
...
@endif
    ...
    <div>
     ...
     <div class="h1">Make Your Query</div><br><br>
     <center>@if(isset($SM))
              <h4>{{$SM}}</h4>
              @endif
        ...
        <div class="dv">
        <center>
                    <img style=" " class="im" src="https://images.squarespace-cdn.com/content/v1/553445d6e4b062ec5813db3a/1462911245550-5O6GEI84C0ILPZUGWUMZ/image-asset.jpeg" alt="">
                </center>
           
            <center><h3 style=" " class="dv1">ask your Query</h3></center>
            
                <div style=" " class="dv2">
                    <form method="post">
                      @csrf
                     <input type="text" placeholder="Your Name" name="name" style=" " class="input" required value="{{old('name')}}">
                    ...
                    value="{{old('email')}}">
                     <span class="text-danger">
                                 @error('email')
                                      {{"Enter Your Email"}}
                                   @enderror</span><br><br>
                    <input type="text" placeholder="Enter Your Query" name="ph" style=" height:60px" class="input" 
                    value="{{old('ph')}}">
                     <span class="text-danger">
                                 @error('ph')
                                      {{"Enter Your Query"}}
                                   @enderror</span><br><br>
                    <input type="submit" name="btn" value="Submit Your Query" style="  " class="btn1"><br><br><br>
                    </form>  
                </div>
