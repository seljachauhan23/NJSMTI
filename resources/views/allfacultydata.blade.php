...
@endif
  ...
  <div class="div">
    ...
    <div>
     ...
     <div class="h1">Faculty Data</div><br><br>
    <form method="get">
      
      <div class="form-group">
        
        <input type="search" name="search" id="" class=" input" placeholder=" Search by Name, Email And Course"  value="{{$search}}">
        <button class="btn1" type="submit"> SEARCH</button>
         <a href="{{url('/allfacultydata')}}"><button type="button" class="btn5">RESET</button></a>
        <a href="{{url('/diraddfaculty')}}"><button type="button" class="btn2">ADD</button></a>
      </div>
    </form>
</div>
    ...
    <table class="table">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td><a href="{{url('')}}/fupdate/{{$faculty->email}}"><button class="btn3">EDIT</button><a></td>
                    <td><a href="{{url('')}}/fdelete/{{$faculty->email}}"><button class="btn4">DELETE</button></a></td>
