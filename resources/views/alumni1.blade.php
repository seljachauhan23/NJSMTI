...
<html lang="en">
  <head>
    ...
    <style>
        ...
        h1{
          padding:50px;
          font-family:Algerian;color:white
        }
        .dv1{
          margin-left:30px;
          margin-right:30px;
  ...
  <div>
            <div class="dv">
                <center> <h1 style="" >MCA Alumni</h1></center>
            </div><br>
            <div style="" class="dv1">
              <center>  <img style="" class="im" src="{{asset('/img/topper.jpg')}}"><br><br>
                <img style="" class="im" src="https://www.veravaleducationsociety.org/njsmti/img/alumini/STARS%20OF%20GALAXY%20(MCA%20DEPARTMENT).png" alt="">
      </center>    
            </div>
    </div><br>
